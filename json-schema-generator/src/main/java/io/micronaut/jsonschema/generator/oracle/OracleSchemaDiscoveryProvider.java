...
/**
 * Reusable Oracle schema authority discovery provider.
 *
 * @since 2.0.0
 */
public interface OracleSchemaDiscoveryProvider {
    ...
    /**
     * Discover Oracle-backed JSON Schemas.
     *
     * @param connection JDBC connection
     * @param source Source configuration
     * @param skipOnError Whether unreadable artifacts should be skipped
     * @param logger Discovery logger
