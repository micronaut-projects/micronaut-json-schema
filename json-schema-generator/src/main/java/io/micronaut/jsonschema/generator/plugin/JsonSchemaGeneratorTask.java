 ...
 * @param javadoc Configuration for javadoc generation
 * @param recordAdoptionStrategy Configuration for when to generate records
 *
...
public record JsonSchemaGeneratorTask(
    ...
    @PluginTaskParameter(defaultValue = "PREFER_RECORD")
