...
include::{includedir}configurationProperties/io.micronaut.jsonschema.configuration.validator.ConfigurationValidatorConfiguration$HealthConfiguration.adoc[]
